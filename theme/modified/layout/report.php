...
<script type='text/javascript' src="<?php echo new moodle_url('/theme/modified/layout/fixH.js');?>"></script>
<script type='text/javascript'>
	window.setTimeout('document.getElementById("headermenu").style.height=fixHe(document.getElementById("page-header-wrapper"),160)+"px";fixReportH();',1000);
</script>
