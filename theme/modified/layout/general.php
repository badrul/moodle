            ...
            <div id="page-header" class="inside">
                <div id="page-header-wrapper" class="wrapper clearfix">
                    ...
                    <?php if ($hasheading) { ?>
						...
						<?php 
						if($ua=='iex6'){
							echo '<img id="headbg" class="headbg" src="'.new moodle_url(get_string('headerbgurl')).'"/>';
							echo '<script type="text/javascript">
							window.setTimeout(\'document.getElementById("headbg").style.height=fixHe(document.getElementById("page-header-wrapper"),160)+"px";\',1000);
                ...
                <div id="region-main-box">
                    <div id="region-post-box">
                        ...
                        <div id="region-main-wrap">
                            <div id="region-main">
                                <div class="region-content <?php echo $ua;?>">
