...
require_once($CFG->dirroot.'/user/filters/spprofilefield.php');
...
class filter {
     ...
     */
    function filter($fieldnames, $baseurl=null, $extraparams=null) {
        global $SESSION;
    ...
    function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
			...
			case 'age': return new user_filter_text('age', get_string('age'), $advanced,'age');
            ...
            default:  return new user_filter_spprofilefield($fieldname, $fieldname, $advanced);;
        }
    }
