...
$ufiltering = new filter(array('Age'=>0,'Gender'=>0,'Qualification'=>0,'Marital Status'=>0,'Monthly Income'=>0,'lastlogin'=>0));
  ...
  // Create our data table.
	...
	<?php
		for ($i = 0; $i< sizeof($table); ++$i ) {
			foreach ($table[$i] as $gender => $total) {
				echo "data.addRow(['" . $gender . "', " . $total . "]);\n";
			}
		}
	?>
	//data.addRow(['Male', 11]);
...
<h3>Reports: Loan Taken</h3>
   <!--Div that will hold the pie chart-->
    <div id="bchart_loan_div"></div>
    <div id="pchart_loan_div"></div>
