...
//added
$string['akpkreport']='Laporan AKPK';
$string['gender']='Jantina';
$string['maritalstatus']='Status Perkahwinan';
$string['income']='Pendapatan Bulanan';
$string['qualification']='Kelayakan';
$string['sitestats']='Statistik Laman Web';
$string['completion']='Statistik Kursus POWER!';
$string['age']='Umur';
$string['loan']='Pinjaman yang telah dibuat';
