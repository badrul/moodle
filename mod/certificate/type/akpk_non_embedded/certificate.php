...
if($certificate->printdate > 0)    {
	...
	$certificatedate =get_string('on', 'certificate').' '.$certificatedate;
}
...
// Add text
    ...
    cert_printtext($x, $y+20, 'C', 'Helvetica', '', 30, $studentname);
    cert_printtext($x, $y+38, 'C', 'Helvetica', '', 18, get_string('statement', 'certificate'));
	print_seal('power.png', $orientation, 120, $y+53, '', '');
