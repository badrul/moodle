...
$string['typeakpk_non_embedded'] = 'AKPK Non-Embedded';
$string['typeakpkms_non_embedded'] = 'AKPK Non-Embedded (Malay)';
...
$string['statement'] = 'HAS COMPLETED THE';
$string['on'] = 'ON';

$string['titlems'] = 'SIJIL PENYERTAAN';
$string['certifyms'] = 'ADALAH DENGAN INI DISAHKAN BAHAWA';
$string['statementms'] = 'TELAH DENGAN JAYANYA MENGIKUTI PROGRAM';
$string['onms'] = 'PADA';
